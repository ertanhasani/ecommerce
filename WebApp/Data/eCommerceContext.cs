...
public class ECommerceContext : DbContext
{
    ...
    public virtual DbSet<SenderSettings> SenderSettings { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AspNetUserTokens>(entity => { entity.HasKey(e => new {e.UserId, e.LoginProvider, e.Name}); });
        ...
        modelBuilder.Entity<SenderSettings>(entity =>
        {
        ...
        modelBuilder.Entity<Status>(entity => { entity.Property(e => e.Name).HasMaxLength(50); });
        ...
        modelBuilder.Entity<Upload>(entity =>
        {
            ...
            entity.HasOne(d => d.Category)
                .WithMany(c => c.Upload)
                .HasForeignKey(d => d.CategoryId)
                .HasConstraintName("FK_Upload_Category");
        });
    }
}