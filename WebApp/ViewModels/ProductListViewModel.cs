...
public class ProductListViewModel
{
    ...
    [Display(Name = "آدرس عکس")] public string ImagePath { get; set; }
    ...
    [Display(Name = "دسته بندی محصول")] public string ProdoctCategories => ProductCategory?.Aggregate("", (current, s) => current + ',' + s).TrimStart(',');
}