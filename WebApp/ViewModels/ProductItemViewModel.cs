...
public class ProductItemViewModel
{
    ...
    [Display(Name = "قیمت فروش")] public decimal SalePrice { get; set; }

    [Display(Name = "تعداد")] public int Quantity { get; set; }

    [Display(Name = "تعداد دست دوم")] public int Stock { get; set; }
    ...
    [Display(Name = "دسته بندی")] public string Categories { get; set; }
}